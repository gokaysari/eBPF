...
export default function SidebarNav() {
  return (
    <ul className="list-unstyled">
      ...
      {/* <SidebarNavGroup toggleIcon={faLocationArrow} toggleText="">
        <SidebarNavItem href="buttons/buttons.html"></SidebarNavItem>
      ...
      {/* <SidebarNavGroup toggleIcon={faBell} toggleText="">
        <SidebarNavItem href="notifications/alerts.html"></SidebarNavItem>
      ...
      <SidebarNavGroup toggleIcon={faStar} toggleText="Pages">
        ...
        <SidebarNavItem icon={faRightToBracket} href="register">Register</SidebarNavItem>



      </SidebarNavGroup>

      <SidebarNavItem  href="docs.html"></SidebarNavItem>
    </ul>
  )
}
